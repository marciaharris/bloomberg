  ...
  return (
    <div className="relative z-10">
      <div className=" fixed top-0 bottom-196 w-full right-0 navbar greyOne drop-shadow-md">
        ...
        <button className="fixed top-1 bottom-196 right-96 btn btn-ghost btn-circle mr-5">
            <img src="https://pbs.twimg.com/media/GM2JpxeXMAAaQQn?format=webp&name=tiny"/>
            Appointments </button>
        <button className="fixed top-1 bottom-196 right-64 btn btn-ghost btn-circle mr-5">
            <img src="https://pbs.twimg.com/media/GM2gYdZWsAAWLGY?format=png&name=120x120"/>
            Messages </button>
